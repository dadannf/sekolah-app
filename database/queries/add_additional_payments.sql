-- ============================================================================
-- QUERY UNTUK MENAMBAHKAN PEMBAYARAN SERAGAM, PTS, DAN PAS
-- ============================================================================

-- 1. ADD COLUMN invoice_type KE spp_invoices TABLE
-- ============================================================================
...
-- 2. ADD COLUMNS UNTUK BIAYA TAMBAHAN KE spp_tariffs TABLE
-- ============================================================================
...
-- 3. SET DEFAULT VALUES UNTUK TARIFF YANG ADA
-- ============================================================================
UPDATE `spp_tariffs` 
...
-- 4. GENERATE INVOICES UNTUK UNIFORM, PTS, DAN PAS UNTUK SEMUA SISWA AKTIF
-- ============================================================================

-- 4a. UNIFORM INVOICES (Bulan 1 - Orientasi)
...
-- 4b. PTS INVOICES (Bulan 5 - Tengah Semester)
INSERT INTO `spp_invoices` 
(`student_id`, `invoice_year`, `invoice_month`, `grade_level_at_invoice`, `tariff_id`, `invoice_type`, `amount_due`, `status`, `created_at`, `updated_at`)
SELECT 
    s.id,
...
-- 4c. PAS INVOICES (Bulan 12 - Akhir Semester)
INSERT INTO `spp_invoices` 
(`student_id`, `invoice_year`, `invoice_month`, `grade_level_at_invoice`, `tariff_id`, `invoice_type`, `amount_due`, `status`, `created_at`, `updated_at`)
SELECT 
    s.id,
...
-- 5. VERIFIKASI DATA YANG TELAH DITAMBAHKAN
-- ============================================================================
...
-- Lihat sample invoices untuk student tertentu
SELECT 'Sample Invoices for Student' AS info,
       s.nis,
       s.name,
       si.invoice_type,
       si.amount_due,
