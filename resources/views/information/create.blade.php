...
@section('page-subtitle', 'Buat pengumuman atau informasi baru untuk siswa')
            ...
            <form method="POST" action="{{ route('information.store') }}" enctype="multipart/form-data">>
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-4">
                            <input type="radio" name="info_type" value="general" id="type-general" class="d-none" {{ old('info_type', 'general') === 'general' ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-4">
                            <input type="radio" name="info_type" value="spp" id="type-spp" class="d-none" {{ old('info_type') === 'spp' ? 'checked' : '' }}>
                        ...
                        <div class="col-12 col-md-4">
                            <input type="radio" name="info_type" value="academic" id="type-academic" class="d-none" {{ old('info_type') === 'academic' ? 'checked' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="body" rows="6" 
                        ...
                        required
                        onfocus="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 0 0 3px rgba(59, 130, 246, 0.1)'"
                        onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">{{ old('body') }}</textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="p-4 rounded-3" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.03) 0%, rgba(29, 78, 216, 0.03) 100%); border: 2px dashed rgba(59, 130, 246, 0.2);">
                        <div class="text-center mb-3">
                            ...
                            <p class="text-muted mb-2" style="font-size: 0.9rem;">Pilih gambar untuk melengkapi informasi</p>
                        </div>
                        ...
                        <div id="imagePreview" class="mt-3" style="display: none;">
                            <div class="position-relative d-inline-block">
                                ...
                                <button type="button" class="btn btn-sm position-absolute top-0 end-0 m-1" 
                                    ...
                                    onclick="removeImagePreview()" title="Hapus gambar">
                ...
                <div class="mb-4 p-4 rounded-3" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.05) 0%, rgba(29, 78, 216, 0.05) 100%); border: 2px dashed rgba(59, 130, 246, 0.2);">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="target_class" value="{{ old('target_class') }}" 
                                class="form-control border-2" 
                                style="border-color: #e2e8f0; border-radius: 8px; padding: 10px 14px; font-size: 0.85rem;"
                ...
                <div class="d-flex gap-3 pt-4 border-top" style="border-color: rgba(59, 130, 246, 0.1) !important;">
                    <button type="submit" class="btn flex-fill fw-semibold text-white border-0 shadow-sm" style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); font-size: 0.9rem; border-radius: 12px; padding: 12px 24px; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 6px 16px rgba(59, 130, 246, 0.4)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 12px rgba(0,0,0,0.1)'">
